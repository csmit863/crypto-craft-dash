      ...
      <nav className="flex gap-0 px-2 py-1 bg-[#c0c7c8] border-b-2 border-[#808080] shadow-[inset_1px_1px_#fff,inset_-1px_-1px_#808080]">
        {[
          ...
          <button
            ...
            className={`px-3 py-1 text-xs border-2 ${activeTab === t.key ? "border-[#808080] border-t-[#808080] border-l-[#808080] bg-[#c0c7c8] shadow-[inset_1px_1px_#fff,inset_-1px_-1px_#808080]" : "border-t-white border-l-white border-b-[#808080] border-r-[#808080] bg-[#c0c7c8] hover:bg-[#dfdfdf]"}`}
          >
            {t.label}
          </button>
        ))}
